...
public class ServicoDeVendas {
    ...
    private double calcularImpostoEstadual(String estado, String pais, double custoItens, List<ItemPedidoModel> itens) {
        ...
        switch (estado.toUpperCase()) {
            case "RS":
                // Orçamentos de menos de R$ 100,00 são isentos. Para orçamentos maiores que R$ 100,00 a alíquota é de 10% sobre o valor que ultrapassa R$ 100,00. 
    ...
    private double calcularDescontos(List<ItemPedidoModel> itens, double custoItens) {
        ...
        // int totalQuantidadeItens = itens.stream().mapToInt(ItemPedidoModel::getQuantidade).sum(); // Não é mais usado diretamente para esta lógica
